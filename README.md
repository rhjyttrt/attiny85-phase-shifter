...
| Mode | Division Ratio | 4 MHz Input | 8 MHz Input | 16 MHz Input | 20 MHz Input |
| :--- | :--- | :--- | :--- | :--- | :--- |
...
Logic analyzer output showing Divide by 12 mode running with a 16 MHz crystal input generating a 1.33 MHz quadrature clock:
